# -*- coding: utf-8 -*-
"""
Created on Wed Jul 26 08:05:59 2023
...
start_date = pd.to_datetime('2021-07-29')
...
plt.plot(df2_filtered['Date/time'], df2_filtered['Depth'], linewidth=2, alpha=1, label='Piezometer 2')
